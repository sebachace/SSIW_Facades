This repository contains the model and data exploring, and fine tuning code to improve on the training of the pytorch model resulting of the following process. 
